...
import sacredBuildingThemeJson from "./themes/sacred-building.json"
...
export const sacredBuildingTheme = sacredBuildingThemeJson as DesktopTheme
...
export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  "sacred-building": sacredBuildingTheme,
  "oc-2": oc2Theme,
  amoled: amoledTheme,
  aura: auraTheme,
  ayu: ayuTheme,
